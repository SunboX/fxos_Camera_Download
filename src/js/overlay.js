...
(function() {
    ...
    function ProgressBar(pMsgId, pClass) {
        ...
        this.update = function(value) {
            ...
            progressElement.setAttribute('value', ((counter * 100) / total).toFixed()); // Percent fraction is not needed.
            showMessage();
        };
    ...
    utils.overlay._show = function(messageId, progressClass, textId) {
        progressActivity.classList.remove('hide');
        if (typeof messageId === 'string') {
            progressTitle.textContent = messageId;
    ...
    utils.overlay.show = function(messageId, progressClass, textId) {
        var out;
    ...
    utils.overlay.showMenu = function() {
        menu.classList.add('showed');
    };

    utils.overlay.hideMenu = function() {
